...
class LabPickDSRLWrapper(gym.Wrapper):
    ...
    def __init__(
        ...
        *,
        ...
        action_dim = self.noise_dim + int(self.gate_enabled)
    ...
    def _blend_gated_noise(
        ...
        gate = self.gate_max * torch.sigmoid(raw_gate / self.gate_temperature)
    ...
    def _apply_gate_reward_and_metrics(
        ...
        gate_per_env = gate.square().mean(dim=-1)
        penalty = self.gate_penalty * gate_per_env
