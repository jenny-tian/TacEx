...
def main() -> None:
    ...
    # Evaluate the policy end to end: execute its predicted rot6d instead of
    # replacing rotation with the simulator-derived labware yaw.
    ...
    summary = {
        ...
        "use_visual_xy_override": args_cli.use_visual_xy_override,
        "execute_bc_rotation": not cfg.rl_align_cafe_action_yaw,
