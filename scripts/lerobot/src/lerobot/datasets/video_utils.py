...
def encode_video_frames(
    ...
    # PyAV's OutputContainer.add_stream expects int/Fraction, not float (no .numerator)
    stream_fps = int(round(float(fps)))
    ...
    with av.open(str(video_path), "w") as output:
        output_stream = output.add_stream(vcodec, stream_fps, options=video_options)
