...
# config — PretrainedConfig.__init_subclass__ wraps subclasses with dataclass(..., kw_only=True).
# Do not apply @dataclass here; a bare @dataclass drops kw_only and breaks field ordering vs the base class.
