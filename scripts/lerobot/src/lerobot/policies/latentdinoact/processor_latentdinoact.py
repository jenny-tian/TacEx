...
from lerobot.policies.latentdinoac.configuration_latentdinoact import LATENTDINOACTConfig
...
def make_latentdinoact_pre_post_processors(
    ...
    """Creates the pre- and post-processing pipelines for the LATENTDINOACT policy.
