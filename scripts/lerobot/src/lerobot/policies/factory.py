...
def _reconnect_relative_absolute_steps(
    ...
    """Reconnect relative/absolute action steps after loading pipeline configs."""
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from lerobot.policies.dinoact.modeling_dinoact import DINOACTPolicy

        return DINOACTPolicy
    elif name == "dinoactrtc":
        from lerobot.policies.dinoactrtc.modeling_dinoactrtc import DINOACTRTCPolicy

        return DINOACTRTCPolicy
    elif name == "vqbet":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "dinoactrtc":
        return DINOACTRTCConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, DINOACTRTCConfig):
        from lerobot.policies.dinoactrtc.processor_dinoactrtc import make_dinoactrtc_pre_post_processors

        processors = make_dinoactrtc_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )

    elif isinstance(policy_cfg, DINOACTConfig):
        from lerobot.policies.dinoact.processor_dinoact import make_dinoact_pre_post_processors

        processors = make_dinoact_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
